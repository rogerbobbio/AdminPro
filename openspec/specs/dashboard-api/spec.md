...
Defines the minimal backend read endpoints that power the Dashboard: the module navigation list and the aggregate summary shown on the Dashboard's stat cards, chart, table, and donut. Established by the `frontend-dashboard` change.
