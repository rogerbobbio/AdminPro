...
## Purpose
Backend HTTP API for managing `Project` and `BaseDeDatos` entities: CRUD endpoints, soft-delete cascading, and structured error mappings for not-found/domain-error cases.
